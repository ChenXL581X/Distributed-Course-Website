...
<div class="main">
		...
		<div class="left info">
			<div class="login-layout">
				...
				<div class="nav-box">
					<ul>
						<li><a href="#top1" class="to-account"><i class="fa fa-user"></i>账号设置</a></li>
						<li><a href="#top2"><i class="fa fa-lock"></i>课程信息</a></li>
						<li><a href="#top3"><i class="fa fa-file-o"></i>动态新闻</a></li>
